...
#------------------------------------------------------------
        ...
        m1 = multMat(addition(a11,a22), addition(b11,b22))
        m2 = multMat(addition(a21,a22),b11)
        m3 = multMat(substract(b12,b22),a11)
        m4 = multMat(substract(b21,b11),a22)
        m5 = multMat(addition(a11,a12),b22)
        m6 = multMat(addition(b11,b12),substract(a21,a11))
        m7 = multMat(addition(b21,b22),substract(a12,a22))
